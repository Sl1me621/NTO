...
def findcolors_(img,colmin,colmax):
    ...
    if contours:
        ...
        return k
        time.sleep(1)    
frame = cv2.imread('stage2/task 4/images/baa25339-ea6f-4e29-a6b7-0acb6c68ca28.jpg')
...
# if numpy.sum(gray_2_1_3) > 10000:
#     ans[1,0,0] = 4
# if numpy.sum(green_2_1_3) > 10000:
#     ans[1,0,0] = 3
# if numpy.sum(red_2_1_3) > 10000:
#     ans[1,0,0] = 2
# if numpy.sum(orange_2_1_3) > 10000:
#     ans[1,0,0] = 5
...
# if numpy.sum(gray_2_2_2) > 10000:
#     ans[1,0,1] = 4
# if numpy.sum(green_2_2_2) > 10000:
#     ans[1,0,1] = 3
# if numpy.sum(red_2_2_2) > 10000:
#     ans[1,0,1] = 2
# if numpy.sum(orange_2_2_2) > 10000:
#     ans[1,0,1] = 5
...
# if numpy.sum(gray_2_3_3) > 10000:
#     ans[1,0,2] = 4
# if numpy.sum(green_2_3_3) > 10000:
#     ans[1,0,2] = 3
# if numpy.sum(red_2_3_3) > 10000:
#     ans[1,0,2] = 2
# if numpy.sum(orange_2_3_3) > 10000:
#     ans[1,0,2] = 5
...
# if numpy.sum(gray_2_4_2) > 10000:
#     ans[1,1,0] = 4
# if numpy.sum(green_2_4_2) > 10000:
#     ans[1,1,0] = 3
# if numpy.sum(red_2_4_2) > 10000:
#     ans[1,1,0] = 2
# if numpy.sum(orange_2_4_2) > 10000:
#     ans[1,1,0] = 5



# if numpy.sum(gray_2_5) > 10000:
#     ans[1,1,1] = 4
# if numpy.sum(green_2_5) > 10000:
#     ans[1,1,1] = 3
# if numpy.sum(red_2_5) > 10000:
#     ans[1,1,1] = 2
# if numpy.sum(orange_2_5) > 10000:
#     ans[1,1,1] = 5
...
# if numpy.sum(gray_2_6_2) > 10000:
#     ans[1,1,2] = 4
# if numpy.sum(green_2_6_2) > 10000:
#     ans[1,1,2] = 3
# if numpy.sum(red_2_6_2) > 10000:
#     ans[1,1,2] = 2
# if numpy.sum(orange_2_6_2) > 10000:
#     ans[1,1,2] = 5
...
# if numpy.sum(gray_2_7_3) > 10000:
#     ans[1,2,0] = 4
# if numpy.sum(green_2_7_3) > 10000:
#     ans[1,2,0] = 3
# if numpy.sum(red_2_7_3) > 10000:
#     ans[1,2,0] = 2
# if numpy.sum(orange_2_7_3) > 10000:
#     ans[1,2,0] = 5
...
# if numpy.sum(gray_2_8_2) > 10000:
#     ans[1,2,1] = 4
# if numpy.sum(green_2_8_2) > 10000:
#     ans[1,2,1] = 3
# if numpy.sum(red_2_8_2) > 10000:
#     ans[1,2,1] = 2
# if numpy.sum(orange_2_8_2) > 10000:
#     ans[1,2,1] = 5
...
# if numpy.sum(gray_2_9_3) > 10000:
#     ans[1,2,2] = 4
# if numpy.sum(green_2_9_3) > 10000:
#     ans[1,2,2] = 3
# if numpy.sum(red_2_9_3) > 10000:
#     ans[1,2,2] = 2
# if numpy.sum(orange_2_9_3) > 10000:
#     ans[1,2,2] = 5
...
if ans[0,2,2] != 0 and ans[1,1,2]  != 0 and ans[1,2,1] !=0:
    ans[1,2,2] = 1          
# h1 = numpy.sum(gray_2_9_1)
# h2 = numpy.sum(red_2_5)
# h2 = numpy.sum(green_2_5)
# h2 = numpy.sum(orange_2_5)
# print(h1)
# print(h2)
# print(h2)
# print(h2)
# cv2.imshow('oran',gray_2_9_1)
# cv2.imshow('orans',red_2_5)
# cv2.imshow('orand',green_2_5)
# cv2.imshow('oranf',orange_2_5)
print(ans)
